                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input class="form-control" oninput="this.value=this.value.replace(/[^0-9.]/g,'');"
                                name="salary" value="{{ old('salary') }}" id="Label-salary" type="text"
                                placeholder="0.00">
                            @error('salary')
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="currency_id">
                                ...
                                @foreach ($other['currencies'] as $info)
                                    <option value="{{ $info['id'] }}" @if (old('currency_id') == $info['id']) selected @endif>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input class="form-control" oninput="this.value=this.value.replace(/[^0-9.]/g,'');"
                                name="monthly_expenses" value="{{ old('monthly_expenses') }}" id="Label-monthly_expenses"
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input class="form-control" oninput="this.value=this.value.replace(/[^0-9.]/g,'');"
                                name="insurance_amount" value="{{ old('insurance_amount') }}" id="Label-insurance_amount"
                                type="text" placeholder="0.00">
