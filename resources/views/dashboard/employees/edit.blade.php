...
@section('admin_title', 'تعديل بيانات الموظف')
@section('css')
    <!-- Select2 -->
...
@section('page-header', ' تعديل بيانات الموظف')
@section('page-header_desc', 'تعديل بيانات الموظف')
                                ...
                                <div class="row my-4"> {{-- Start First Row of From --}}
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <input type="text" class="form-control font-w" name="employee_code"
                                            value="{{ old('employee_code') }}" id="exampleInputName"
