    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="card card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form action="{{ route('dashboard.employees.store') }}" method="POST" role="form"
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="form-group col-6">
                                ...
                                <input type="text" class="form-control" name="name" value="{{ old('name') }}"
                                    id="exampleInputName" placeholder="أدخل اسم الموظف">
                                @error('name')
                        ...
                        <div class="form-group">
                            <label for="exampleInputFile">صورة الموظف</label>
